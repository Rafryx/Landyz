...
<body>
  ...
  <div id="map">
    <div class="block">
      <div class='block-header'>
        <select name="" id="tipo" onchange="">
          <option value='tipo'>Escolha a categoria que pretende filtrar</option>
      ...
      <div class="block-container">
        <div class='block-card'>
          ...
          <div class="block-card-info">
            <label for="">Dados do lote: Teste</label><br>
            <label for="">Metros quadrados: Teste</label><br>
            <label for="">Venda ou Aluguer: Teste</label><br>
          </div>
          <div class="block-card-buttons">
            <button><i class="material-icons">call</i>Entrar em contato</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <script>
    var map = L.map('map').setView([-10.249923, -48.324174], 16);
