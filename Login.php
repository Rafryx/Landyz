...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="CSS/Landyz.css">
  <title>Landyz</title>
      ...
      <div class="content">
        ...
        <div id="login">
            ...
            <p>
              ...
              <input id="txt-email" class="email-login" name="email_login" type="text" placeholder="ex. contato@htmlecsspro.com" />
            </p>

            <p>
              <label for="senha_login">Senha</label>
              <input id="txt-senha" class="senha-login" name="senha_login" type="password" placeholder="ex. senha" />
            </p>
        ...
        <div id="cadastro">
          ...
          <p>
            ...
            <input id="tx-nome" class="name" name="nome_cad" type="text" placeholder="nome" />
          </p>

          <p>
            <label for="email_cad">E-mail</label>
            <input id="tx-email" class="email" name="email_cad" type="email" placeholder="ex: contato@email.com" />
          </p>

          <p>
            <label for="senha_cad">Senha</label>
            <input id="tx-senha" class="password" name="senha_cad" type="password" placeholder="ex: 1234" />
          </p>
